...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='event',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='arrangemang', null=True, to='events.Event'),
        ),
        migrations.AlterField(
            model_name='entryasparticipant',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='användare', null=True, to=settings.AUTH_USER_MODEL),
        ),
        migrations.AlterField(
