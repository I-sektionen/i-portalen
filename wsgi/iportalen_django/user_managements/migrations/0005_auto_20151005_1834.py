...
class Migration(migrations.Migration):
    dependencies = [
        ('user_managements', '0004_auto_20151005_1821'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.IntegerField(
                choices=[(1969, 1969), (1970, 1970), (1971, 1971), (1972, 1972), (1973, 1973), (1974, 1974),
                         ...
                         (2023, 2023), (2024, 2024)], default=2020, verbose_name='förväntat examensår'),
        ),
        migrations.AlterField(
            model_name='iuser',
            name='start_year',
            field=models.IntegerField(
                choices=[(1969, 1969), (1970, 1970), (1971, 1971), (1972, 1972), (1973, 1973), (1974, 1974),
                         ...
                         (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016),
                         (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022),
                         (2023, 2023), (2024, 2024)], default=2015, verbose_name='startår'),
        ),
    ]
