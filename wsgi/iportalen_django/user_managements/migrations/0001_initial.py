    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(validators=[django.core.validators.RegexValidator('^[a-zA-Z]{5}\\d{3}$')],
                                              verbose_name='LiU-ID', unique=True, max_length=8)),
                ...
                ('start_year', models.IntegerField(
                    choices=[(2005, 2005), (2006, 2006), (2007, 2007), (2008, 2008), (2009, 2009), (2010, 2010),
                             (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016),
                             (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022),
                             (2023, 2023), (2024, 2024)], verbose_name='start år', default=2015)),
                ('expected_exam_year', models.IntegerField(
                    choices=[(2005, 2005), (2006, 2006), (2007, 2007), (2008, 2008), (2009, 2009), (2010, 2010),
                             (2011, 2011), (2012, 2012), (2013, 2013), (2014, 2014), (2015, 2015), (2016, 2016),
                             (2017, 2017), (2018, 2018), (2019, 2019), (2020, 2020), (2021, 2021), (2022, 2022),
                             (2023, 2023), (2024, 2024)], verbose_name='förväntat examens år', default=2020)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(to='user_managements.BachelorProfile', verbose_name='kandidatprofil', null=True,
                                    blank=True),
        ),
        migrations.AddField(
            model_name='iuser',
            name='groups',
            field=models.ManyToManyField(to='auth.Group', verbose_name='groups', related_name='user_set',
        ...
        migrations.AddField(
            model_name='iuser',
            name='master_profile',
            field=models.ForeignKey(to='user_managements.MasterProfile', verbose_name='masterprofil', null=True,
                                    blank=True),
        ),
        migrations.AddField(
            model_name='iuser',
            name='user_permissions',
            field=models.ManyToManyField(to='auth.Permission', verbose_name='user permissions', related_name='user_set',
                                         related_query_name='user', blank=True,
