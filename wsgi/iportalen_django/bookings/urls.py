...
urlpatterns = [
    url(r'^book/(?P<bookable_id>[0-9]+)/$', views.make_booking, name="make booking"),
    url(r'^book/(?P<bookable_id>[0-9]+)/(?P<weeks_forward>[0-9]+)/$', views.make_booking, name="make booking week"),
