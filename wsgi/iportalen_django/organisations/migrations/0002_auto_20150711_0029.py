    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(
                choices=[('N', 'Inte i menyn'), ('S', 'Sektionen'), ('F', 'Föreningar'), ('U', 'Utskott')], default='N',
                max_length=1, verbose_name='Meny',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='parent', verbose_name='Föräldrar organisation', blank=True,
                                    to='organisations.Organisation', null=True,
