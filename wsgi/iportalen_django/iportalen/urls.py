...
from .views import create_content, approve_content, placeholder, article_pagination, single_news_feed
...
urlpatterns = [
    ...
    url(r'^single$', view=single_news_feed, name="single_news_feed"),
